...
// OrigErr returns the invalid parameters as a sdferr.BatchedErrors value
func (e ErrInvalidParams) OrigErr() error {
	return sdferr.NewBatchError(
...
// OrigErr returns nil, Implemented for sdferr.Error interface.
