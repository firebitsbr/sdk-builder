...
import (
	...
	"github.com/polefishu/sdk-builder/sdf/signer/awssig"
...
func TestStandaloneSign_CustomURIEscape(t *testing.T) {
	...
	signer := awssig.NewSigner(creds, func(s *awssig.Signer) {
...
func TestStandaloneSign_WithPort(t *testing.T) {
	...
	for _, c := range cases {
		signer := awssig.NewSigner(unit.Session.Config.Credentials)
