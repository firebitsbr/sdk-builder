...
func (p Provider) Retrieve() (credentials.Value, error) {
	...
	if err != nil {
		return creds, sdferr.New(ErrCodePluginProviderRetrieve,
...
func GetPluginProviderFnsByName(p *plugin.Plugin, symbolName string) (func() (key, secret, token string, err error), func() bool, error) {
	...
	if err != nil {
		return nil, nil, sdferr.New(ErrCodeLookupSymbolError,
	...
	if !ok {
		return nil, nil, sdferr.New(ErrCodeInvalidSymbolError,
	...
	if retrieveFn == nil {
		return nil, nil, sdferr.New(ErrCodePluginRetrieveNil,
			"the plugin provider retrieve function cannot be nil", nil)
	}
	if isExpiredFn == nil {
		return nil, nil, sdferr.New(ErrCodePluginIsExpiredNil,
