...
func logRequest(r *request.Request) {
	logBody := r.Config.LogLevel.Matches(sdf.LogDebugWithHTTPBody)
	bodySeekable := sdf.IsReaderSeekable(r.Body)
	...
	if logBody {
		if !bodySeekable {
			r.SetReaderBody(sdf.ReadSeekCloser(r.HTTPRequest.Body))
		}
...
func logResponse(r *request.Request) {
	...
	handlerFn := func(req *request.Request) {
		...
		if req.Config.LogLevel.Matches(sdf.LogDebugWithHTTPBody) {
