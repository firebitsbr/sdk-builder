...
func TestNewDefaultSession(t *testing.T) {
	...
	s := New(&sdf.Config{Region: sdf.String("region")})
	...
	assert.Equal(t, sdf.LogOff, *s.Config.LogLevel)
}
...
func TestNew_WithCustomCreds(t *testing.T) {
	...
	s := New(&sdf.Config{Credentials: customCreds})
...
func TestNew_WithSessionLoadError(t *testing.T) {
	...
	logger := bytes.Buffer{}
	s := New(&sdf.Config{Logger: &mockLogger{&logger}})
...
func TestSessionCopy(t *testing.T) {
	...
	newSess := s.Copy(&sdf.Config{Region: sdf.String("new_region")})
...
func TestSessionClientConfig(t *testing.T) {
	s, err := NewSession(&sdf.Config{
		Credentials: credentials.AnonymousCredentials,
		Region:      sdf.String("orig_region"),
	...
	cfg := s.ClientConfig("mock-service", &sdf.Config{Region: sdf.String("other-region")})
...
func TestSesisonAssumeRole(t *testing.T) {
	...
	s, err := NewSession(&sdf.Config{Endpoint: sdf.String(server.URL), DisableSSL: sdf.Bool(true)})
