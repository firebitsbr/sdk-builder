...
When creating Sessions optional sdf.Config values can be passed in that will
...
SDK defaults, and user provided sdf.Config values.
...
Setting a custom HTTPClient in the sdf.Config options will override this setting.
