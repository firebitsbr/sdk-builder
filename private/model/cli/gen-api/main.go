...
import (
	...
	"github.com/polefishu/sdk-builder/private/model/api"
	"github.com/polefishu/sdk-builder/private/util"
)
...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/polefishu/sdk-builder/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
	...
	// switch os.Getenv("MODULES") {
	// case Tencent:
	// 	svcPath = filepath.Join(svcPath, Tencent)
	// }
