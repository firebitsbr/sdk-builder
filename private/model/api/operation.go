...
func (o *Operation) GetSigner() string {
	if o.AuthType == "v4-unsigned-body" {
		o.API.imports["github.com/polefishu/sdk-builder/sdf/signer/v4"] = true
	}
...
func (c *{{ .API.StructName }}) {{ .ExportedName }}WithContext(` +
	`ctx sdf.Context, input {{ .InputRef.GoType }}, opts ...request.Option) ` +
...
{{ .ExportedName }}WithContext(sdf.Context, {{ .InputRef.GoTypeWithPkgName }}, ...request.Option) ({{ .OutputRef.GoTypeWithPkgName }}, error)
...
{{ .ExportedName }}PagesWithContext(sdf.Context, {{ .InputRef.GoTypeWithPkgName }}, func({{ .OutputRef.GoTypeWithPkgName }}, bool) bool, ...request.Option) error
{{- end }}
`))
...
func (o *Operation) ExampleInput() string {
	if len(o.InputRef.Shape.MemberRefs) == 0 {
		if strings.Contains(o.InputRef.GoTypeElem(), ".") {
			o.imports["github.com/polefishu/sdk-builder/service/"+strings.Split(o.InputRef.GoTypeElem(), ".")[0]] = true
