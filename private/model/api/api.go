...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/polefishu/sdk-builder/sdf": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	a.imports["github.com/polefishu/sdk-builder/sdf/sdfutil"] = true
	a.imports["github.com/polefishu/sdk-builder/sdf/request"] = true
	if a.OperationHasOutputPlaceholder() {
		a.imports["github.com/polefishu/sdk-builder/sdf/protocol/"+a.ProtocolPackage()] = true
		a.imports["github.com/polefishu/sdk-builder/sdf/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/polefishu/sdk-builder/sdf/credentials"] = true
			break
		}
	}
...
func New(p client.ConfigProvider, cfgs ...*sdf.Config) *{{ .StructName }} {
...
func newClient(cfg sdf.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *{{ .StructName }} {
    svc := &{{ .StructName }}{
    	Client: client.New(
    		cfg,
    		metadata.ClientInfo{
	...
	{{end}}
	{{if eq .Metadata.SignatureVersion "alicloud"}}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/polefishu/sdk-builder/sdf/client"] = true
	a.imports["github.com/polefishu/sdk-builder/sdf/client/metadata"] = true
	a.imports["github.com/polefishu/sdk-builder/sdf/request"] = true

	switch a.Metadata.SignatureVersion {
	case "v2":
	...
	case "alicloud":
		a.imports["github.com/polefishu/sdk-builder/sdf/signer/alicloudsig"] = true
	}
...
func (a *API) InterfaceGoCode() string {
	...
	a.imports = map[string]bool{
		"github.com/polefishu/sdk-builder/sdf":            true,
		"github.com/polefishu/sdk-builder/sdf/request":    true,
