...
func (c *CloudWatch) WaitUntilAlarmExists(input *DescribeAlarmsInput) error {
	return c.WaitUntilAlarmExistsWithContext(sdf.BackgroundContext(), input)
}
...
func (c *CloudWatch) WaitUntilAlarmExistsWithContext(ctx sdf.Context, input *DescribeAlarmsInput, opts ...request.WaiterOption) error {
	w := request.Waiter{
