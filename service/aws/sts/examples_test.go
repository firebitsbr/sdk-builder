...
import (
	...
	"github.com/polefishu/sdk-builder/sdf/awserr"
...
func ExampleSTS_AssumeRole_shared00() {
	...
	input := &sts.AssumeRoleInput{
		DurationSeconds: sdf.Int64(3600),
		ExternalId:      sdf.String("123ABC"),
		Policy:          sdf.String("{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"Stmt1\",\"Effect\":\"Allow\",\"Action\":\"s3:*\",\"Resource\":\"*\"}]}"),
		RoleArn:         sdf.String("arn:aws:iam::123456789012:role/demo"),
		RoleSessionName: sdf.String("Bob"),
	}
...
func ExampleSTS_DecodeAuthorizationMessage_shared00() {
	...
	input := &sts.DecodeAuthorizationMessageInput{
		EncodedMessage: sdf.String("<encoded-message>"),
	}
...
func ExampleSTS_GetSessionToken_shared00() {
	...
	input := &sts.GetSessionTokenInput{
		DurationSeconds: sdf.Int64(3600),
		SerialNumber:    sdf.String("YourMFASerialNumber"),
		TokenCode:       sdf.String("123456"),
	}
