...
type STSAPI interface {
	...
	AssumeRoleWithContext(sdf.Context, *sts.AssumeRoleInput, ...request.Option) (*sts.AssumeRoleOutput, error)
	...
	AssumeRoleWithSAMLWithContext(sdf.Context, *sts.AssumeRoleWithSAMLInput, ...request.Option) (*sts.AssumeRoleWithSAMLOutput, error)
	...
	AssumeRoleWithWebIdentityWithContext(sdf.Context, *sts.AssumeRoleWithWebIdentityInput, ...request.Option) (*sts.AssumeRoleWithWebIdentityOutput, error)
	...
	DecodeAuthorizationMessageWithContext(sdf.Context, *sts.DecodeAuthorizationMessageInput, ...request.Option) (*sts.DecodeAuthorizationMessageOutput, error)
	...
	GetCallerIdentityWithContext(sdf.Context, *sts.GetCallerIdentityInput, ...request.Option) (*sts.GetCallerIdentityOutput, error)
	GetCallerIdentityRequest(*sts.GetCallerIdentityInput) (*request.Request, *sts.GetCallerIdentityOutput)

	GetFederationToken(*sts.GetFederationTokenInput) (*sts.GetFederationTokenOutput, error)
	GetFederationTokenWithContext(sdf.Context, *sts.GetFederationTokenInput, ...request.Option) (*sts.GetFederationTokenOutput, error)
	...
	GetSessionTokenWithContext(sdf.Context, *sts.GetSessionTokenInput, ...request.Option) (*sts.GetSessionTokenOutput, error)
